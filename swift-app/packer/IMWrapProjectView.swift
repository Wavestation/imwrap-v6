...
struct IMWrapProjectView: View {
    ...
    private var tracksGroupBox: some View {
        GroupBox("Assemblage des Pistes MIDI (Format 2)") {
            VStack(spacing: 10) {
                Text("iMWrap conserve un stockage MIDI de type 2 pour placer chaque segment ou boucle sur une piste distincte.")
                    .font(.caption)
                    .foregroundColor(.secondary)
                    .frame(maxWidth: .infinity, alignment: .leading)
