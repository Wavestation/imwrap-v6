...
namespace AgsIMWrap
{
    public enum IMWrapAuthoringProfile : int
    {
        GeneralMidi = 0,
        Mt32 = 1,
        Adlib = 2
    ...
    public static class IMWrapShim
    {
        private const string DLL_NAME = "imwrap_shim.dll";
        ...
        public static extern UIntPtr BankEventCount(IntPtr handle, ushort soundId, IMWrapAuthoringProfile profile);

        [DllImport(DLL_NAME, EntryPoint = "imwrap_bank_event_summary", CallingConvention = CallingConvention.Cdecl)]
        public static extern int BankEventSummary(IntPtr handle, ushort soundId, IMWrapAuthoringProfile profile, UIntPtr index, out uint tick, out ushort track, StringBuilder buffer, UIntPtr bufferSize);

        [DllImport(DLL_NAME, EntryPoint = "imwrap_bank_track_count", CallingConvention = CallingConvention.Cdecl)]
        public static extern UIntPtr BankTrackCount(IntPtr handle, ushort soundId, IMWrapAuthoringProfile profile);

        [DllImport(DLL_NAME, EntryPoint = "imwrap_bank_track_summary", CallingConvention = CallingConvention.Cdecl)]
        public static extern int BankTrackSummary(IntPtr handle, ushort soundId, IMWrapAuthoringProfile profile, UIntPtr trackIndex, StringBuilder nameBuffer, UIntPtr nameBufferSize, out UIntPtr eventCount);
        ...
        public static extern void EngineSetProfile(IntPtr handle, IMWrapAuthoringProfile profile);
