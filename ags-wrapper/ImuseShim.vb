...
Namespace AgsImuse
    ...
    Public NotInheritable Class ImuseShim
        Private Const DLL_NAME As String = "imuse_shim.dll"
        ...
        Public Shared Function BankEventCount(ByVal handle As IntPtr, ByVal soundId As UShort, ByVal profile As ImuseAuthoringProfile) As UIntPtr
        End Function

        <DllImport(DLL_NAME, EntryPoint:="imuse_bank_event_summary", CallingConvention:=CallingConvention.Cdecl)>
        Public Shared Function BankEventSummary(ByVal handle As IntPtr, ByVal soundId As UShort, ByVal profile As ImuseAuthoringProfile, ByVal index As UIntPtr, <Out> ByRef tick As UInteger, <Out> ByRef track As UShort, ByVal buffer As StringBuilder, ByVal bufferSize As UIntPtr) As Integer
        End Function

        <DllImport(DLL_NAME, EntryPoint:="imuse_bank_track_count", CallingConvention:=CallingConvention.Cdecl)>
        Public Shared Function BankTrackCount(ByVal handle As IntPtr, ByVal soundId As UShort, ByVal profile As ImuseAuthoringProfile) As UIntPtr
        End Function

        <DllImport(DLL_NAME, EntryPoint:="imuse_bank_track_summary", CallingConvention:=CallingConvention.Cdecl)>
        Public Shared Function BankTrackSummary(ByVal handle As IntPtr, ByVal soundId As UShort, ByVal profile As ImuseAuthoringProfile, ByVal trackIndex As UIntPtr, ByVal nameBuffer As StringBuilder, ByVal nameBufferSize As UIntPtr, <Out> ByRef eventCount As UIntPtr) As Integer
        End Function
        ...
        Public Shared Sub EngineSetProfile(ByVal handle As IntPtr, ByVal profile As ImuseAuthoringProfile)
        End Sub
