...
#ifndef IMWRAP_INSTRUMENT_H
#define IMWRAP_INSTRUMENT_H

#include <cstdint>
#include <memory>

#include "imwrap/Export.h"
#include "imwrap/MidiChannel.h"
...
IMWRAP_API void RegisterRolandTimbreMapping(const char *name, uint8_t gmProgram);
IMWRAP_API void ClearRolandTimbreMappings();
