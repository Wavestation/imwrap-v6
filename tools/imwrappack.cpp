...
using imwrap::SoundBankInput;
using imwrap::VariantKind;
using imwrap::VariantSource;

void PrintUsage() {
    std::cerr
        << "Usage:\n"
        << "  imwrappack build output.ims [--name=80:Woodtick] [--mdhd=80:gmd:90:127:0:0:0:128] 80:gmd=file.mid [80:rol=file.mid...]\n";
}
